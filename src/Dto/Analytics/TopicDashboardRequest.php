...
final class TopicDashboardRequest
{
    public const COMPARISON_WINDOWS = [6, 12, 24];
    public const FORECAST_WINDOWS = [6, 12];
    ...
    public static function fromRequest(Request $request): self
    {
        ...
        $forecastMonths = self::parseAllowedInteger(
            $request->query->get('forecastMonths', '12'),
            'forecastMonths',
        ...
        return new self($periodStart, $periodEnd, $comparisonWindowMonths, $forecastMonths, $errors);
    }
